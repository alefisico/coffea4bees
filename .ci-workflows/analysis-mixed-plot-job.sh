...
python analysis/makePlotsMixed.py analysis/hists/testMixedBkg_master.coffea analysis/hists/testMixedData_master.coffea --combine_input_files -m analysis/metadata/plotsMixed.yml   -o analysis/testMixedPlots
#python analysis/makePlots.py analysis/hists/test.coffea    -o analysis/testCoffeaPlots -m analysis/metadata/plotsAll.yml
echo "############### Checking if pdf files exist"
ls analysis/testMixedPlots/RunII/passPreSel/fourTag/SR/
