...
python runner.py -t -o testMixedBkg_data_3b_for_mixed_kfold.coffea -d   data_3b_for_mixed  -p analysis/processors/processor_HH4b.py -y 2017 2018 2016  -op analysis/hists/ -m $DATASETS
...
python runner.py -t -o testSignal_UL.coffea -d GluGluToHHTo4B_cHHH1 ZH4b ZZ4b  -p analysis/processors/processor_HH4b.py -y UL17 UL18 UL16_preVFP UL16_postVFP    -op analysis/hists/ -m $DATASETS
...
python stats_analysis/convert_hist_to_json_closure.py --input analysis/hists/testMixedBkg_data_3b_for_mixed_kfold.coffea
