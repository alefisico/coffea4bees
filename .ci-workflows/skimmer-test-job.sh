...
sed -e "s#/TTToSemiLeptonic_TuneCP5_13TeV-powheg-pythia8/RunIISummer20UL18NanoAODv9-106X_upgrade2018_realistic_v16_L1v1-v1/NANOAODSIM#/srv/python/metadata/nano_TTToSemiLeptonic_ci.txt#" metadata/datasets_HH4b.yml > metadata/datasets_ci.yml
