...
time python runner.py -s -p skimmer/processor/make_declustered_data_4b.py -c skimmer/metadata/declustering_for_test.yml -y UL18 -e A -d data -op skimmer/metadata/ -o picoaod_datasets_declustered_data_test_UL18.yml -m metadata/datasets_HH4b.yml
ls -R skimmer/
cd ../
