...
python runner.py -t -o dummy.coffea -d GluGluToHHTo4B_cHHH1 -p analysis/processors/processor_trigger_weights.py -y UL18 -op analysis/metadata/ -c analysis/metadata/trigger_weights.yml -m $DATASETS
ls
cd ../
