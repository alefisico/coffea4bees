...
class clusteringTestCase(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        self.input_jets_4 = ak.zip(
            {
                ...
                "btagScore": self.input_jet_pt_4, ## Hack
            },
        ...
        self.input_btagScore_5 = [[1.0] * 5] * len(self.input_jet_pt_5)# Dummy
        self.input_jets_5 = ak.zip(
            {
                ...
                "btagScore": self.input_jet_pt_5, ## Hack
            },
            with_name="PtEtaPhiMLorentzVector",
            behavior=vector.behavior,
        )
        ...
        self.input_jets_bbj = ak.zip(
            {
                ...
                "btagScore": self.input_btagScore_bbj,
            },
            with_name="PtEtaPhiMLorentzVector",
            behavior=vector.behavior,
        )
        ...
        self.input_jets_6 = ak.zip(
            {
                ...
                "btagScore": self.input_jet_pt_6, ## Hack
            },
            with_name="PtEtaPhiMLorentzVector",
            behavior=vector.behavior,
        )
        ...
        self.input_jets_5b = ak.zip(
            {
                ...
                "btagScore": self.input_jet_pt_5b, ## Hack
            },
            with_name="PtEtaPhiMLorentzVector",
            behavior=vector.behavior,
        )
        ...
        self.input_jets_HH_3b = ak.zip(
            {
                ...
                "btagScore": self.input_jet_pt_HH_3b + self.input_jet_pt_HH_3b, ## Hack
            },
            with_name="PtEtaPhiMLorentzVector",
            behavior=vector.behavior,
        )
        ...
        self.input_jets_bad_split = ak.zip(
            {
                ...
                "btagScore": self.input_jet_pt_bad_split, ## Hack
            },
            with_name="PtEtaPhiMLorentzVector",
            behavior=vector.behavior,
        )
...
#        stats.print_stats()
    ...
    def _synthetic_datasets_test(self, input_jets, n_jets_expected, debug=False):
        ...
        if debug:
            ...
            print(f"declustered_jets.btagScore  {declustered_jets.btagScore}")
