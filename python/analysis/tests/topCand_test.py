...
class topCandRecoTestCase(unittest.TestCase):
    ...
    def setUpClass(self):
        ...
        #
        self.input_jet_pt = [[243, 223, 71.8, 67.8], [181, 119, 116, 96.9], [208, 189, 62.4, 52.1]]
        self.input_jet_eta = [[1.51, 0.516, 0.656, 0.99], [2.02, 0.795, 0.747, 1.45], [1.09, -0.219, 1.5, 0.66]]
        self.input_jet_phi = [[-2.88, 0.5, -1.88, 0.118], [-0.834, 1.87, 2.71, 1.8], [2.21, -0.736, -2.53, 2.12]]
        self.input_jet_mass = [[28.9, 30.8, 9.66, 13.2], [19.7, 22.8, 15.8, 12.2], [25.8, 24.7, 8.77, 7.87]]
        self.input_jet_btagDeepFlavB = [[0.999, 0.907, 0.0116, 0.685], [0.603, 1, 0.997, 0.646], [0.985, 0.975, 0.0113, 0.967]]
        self.input_jet_bRegCorr = [[1.1, 1.12, 1.07, 1.02], [0.962, 1, 1.18, 0.977], [1.01, 1.01, 1.09, 1.29]]
        self.output_xbW =  [5.1162261962890625, 3.6441168785095215, 0.7684999108314514]
        self.output_xW = [3.4038572311401367, 7.014884948730469, 1.7819664478302002]
