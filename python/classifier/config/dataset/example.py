...
from classifier.df.tools import (add_event_offset, add_label_index_from_column,
...
class _Common(LoadGroupedRoot):
    ...
    def from_root(self, groups: frozenset[str]):
        ...
        return FromRoot(friends=friends, branches=self._branches, preprocessors=pres, metadata=metadata)
    ...
    @classmethod
    @abstractmethod
    def preprocessor_by_label(cls) -> Iterable[tuple[Iterable[Iterable[str]], Iterable[Callable[[pd.DataFrame], pd.DataFrame]]]]:
        ...
