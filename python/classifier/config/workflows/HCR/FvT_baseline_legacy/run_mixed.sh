...
export MODEL="${BASE}/classifier/FvT/baseline_legacy"
export WEB="root://eosuser.cern.ch//eos/user/${CERNUSER}/www/HH4b/classifier/FvT_baseline/legacy/"
...
for i in {0..14}
do
    ./pyml.py template "{mixed: ${i}, user: ${LPCUSER}}" $WFS/evaluate_mixed.yml
done