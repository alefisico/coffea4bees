...
def doPlots(varList, debug=False):
    ...
    # Fig 34
    plot("selJets.n",     region="SB",yscale="linear",norm=0,rebin=1,doratio=1,rlim=[0.5,1.5],xlim=[4,15])
    plot("nPSplusTagJets",region="SB",yscale="log",   norm=0,rebin=1,doratio=1,rlim=[0.5,1.5],xlim=[4,8])
