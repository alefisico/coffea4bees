...
def doPlots(varList, debug=False):
    ...
    plot("selJets_noJCM.n",region="SB",yscale="linear",norm=0,rebin=1,doratio=1,rlim=[0.5,1.5],xlim=[4,15])
    plot("tagJets_noJCM.n",region="SB",yscale="linear",norm=0,rebin=1,doratio=1,rlim=[0.5,1.5],xlim=[0,8])
