...
#    plot("SvB_MA_noFvT.ps_hh_fine",region="SB",yscale="log",norm=0,rebin=8,doratio=1,rlim=[0.5,1.5])
#    plot("SvB_MA.ps_hh_fine",      region="SB",yscale="log",norm=0,rebin=8,doratio=1,rlim=[0.5,1.5])
