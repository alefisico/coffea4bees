...
if [[ $(hostname) = *fnal* ]]; then
    ...
    sed -e "s|trigWeight: .*|trigWeight: \/builds\/${CI_PROJECT_PATH}\/$INPUT_DIR\/trigger_weights_friends.json@@trigWeight|" analysis/metadata/HH4b_signals.yml > $OUTPUT_DIR/trigger_weights_HH4b.yml
fi
