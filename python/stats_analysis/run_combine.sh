...
do
    ...
    text2workspace.py ${datacard}.txt -P HiggsAnalysis.CombinedLimit.PhysicsModel:multiSignalModel --PO verbose --PO "map=.*/${signallabel}:r${signallabel}[1,-10,10]" \
        --PO "map=.*/ggHH_kl_0_kt_1:rggHH_kl_0_kt_1[1,-10,10]" \
        --PO "map=.*/ggHH_kl_2p45_kt_1:rggHH_kl_2p45_kt_1[1,-10,10]" \
        --PO "map=.*/ggHH_kl_5_kt_1:rggHH_kl_5_kt_1[1,-10,10]" 
    ...
    if [ "$impacts" = true ]; then
        ...
        --setParameterRanges r${signallabel}=-10,10:rggHH_kl_0_kt_1=-10,10:rggHH_kl_2p45_kt_1=-10,10:rggHH_kl_5_kt_1=-10,10 \
        ...
        --setParameters r${signallabel}=1,rggHH_kl_0_kt_1=1,rggHH_kl_2p45_kt_1=1,rggHH_kl_5_kt_1=1 \
